...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*DaemonSetConfig)(nil), (*v1beta1.DaemonSetConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_DaemonSetConfig_To_v1beta1_DaemonSetConfig(a.(*DaemonSetConfig), b.(*v1beta1.DaemonSetConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.DaemonSetConfig)(nil), (*DaemonSetConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_DaemonSetConfig_To_v1alpha3_DaemonSetConfig(a.(*v1beta1.DaemonSetConfig), b.(*DaemonSetConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_CNISpec_To_v1beta1_CNISpec(in *CNISpec, out *v1beta1.CNISpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha3_DaemonSetConfig_To_v1beta1_DaemonSetConfig(&in.DaemonSet, &out.DaemonSet, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_CNISpec_To_v1alpha3_CNISpec(in *v1beta1.CNISpec, out *CNISpec, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_DaemonSetConfig_To_v1alpha3_DaemonSetConfig(&in.DaemonSet, &out.DaemonSet, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha3_DaemonSetConfig_To_v1beta1_DaemonSetConfig(in *DaemonSetConfig, out *v1beta1.DaemonSetConfig, s conversion.Scope) error {
	out.Env = *(*map[string]string)(unsafe.Pointer(&in.Env))
	return nil
}

// Convert_v1alpha3_DaemonSetConfig_To_v1beta1_DaemonSetConfig is an autogenerated conversion function.
func Convert_v1alpha3_DaemonSetConfig_To_v1beta1_DaemonSetConfig(in *DaemonSetConfig, out *v1beta1.DaemonSetConfig, s conversion.Scope) error {
	return autoConvert_v1alpha3_DaemonSetConfig_To_v1beta1_DaemonSetConfig(in, out, s)
}

func autoConvert_v1beta1_DaemonSetConfig_To_v1alpha3_DaemonSetConfig(in *v1beta1.DaemonSetConfig, out *DaemonSetConfig, s conversion.Scope) error {
	out.Env = *(*map[string]string)(unsafe.Pointer(&in.Env))
	return nil
}

// Convert_v1beta1_DaemonSetConfig_To_v1alpha3_DaemonSetConfig is an autogenerated conversion function.
func Convert_v1beta1_DaemonSetConfig_To_v1alpha3_DaemonSetConfig(in *v1beta1.DaemonSetConfig, out *DaemonSetConfig, s conversion.Scope) error {
	return autoConvert_v1beta1_DaemonSetConfig_To_v1alpha3_DaemonSetConfig(in, out, s)
}
